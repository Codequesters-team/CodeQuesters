  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        perspective: {
          technical: "hsl(var(--perspective-technical))",
          educational: "hsl(var(--perspective-educational))",
          creative: "hsl(var(--perspective-creative))",
          business: "hsl(var(--perspective-business))",
          scientific: "hsl(var(--perspective-scientific))"
        },
        sidebar: {
